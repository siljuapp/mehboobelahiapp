...
window.addEventListener("beforeinstallprompt", (e) => {
    ...
    // Optionally, show a custom UI prompt (button, banner, etc.) for the user to click
    // For example, you can display an "Install" button
    document.getElementById("installButton").style.display = "block"; // Show a button when the prompt is ready
});
...
function promptInstall() {
    if (deferredPrompt) {
        ...
        deferredPrompt.userChoice.then((choiceResult) => {
            ...
            // Optionally, hide the install button after the prompt is shown

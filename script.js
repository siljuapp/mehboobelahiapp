            ...
            <div className="flex flex-col justify-center items-center h-screen">
                <div id="loading-animation" className="flex justify-center items-center h-screen">
                    <div className="relative w-24 h-24">
                        ...
                        <div className="hide absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                ...
                <div className="page-container flex flex-col justify-center items-center w-full h-full">
                    <div className="user-info p-2  flex flex-col justify-start items-start gap-2 w-full">
                        <div className="flex gap-2 justify-start items-start w-full py-2">
                            ...
                            <div className="exam-div dropdown-div ml-auto">
                                <button
                    ...
                    <div className="app-features w-full flex flex-col justify-start items-start gap-2  py-3 px-4  my-5">
                        <h1 className="text-xl font-bold text-gray-800">App Features:</h1>
                        <div className="flex justify-start mcq items-center gap-2">
                            <i className="fa-regular fa-circle-check text-green-500"></i>
                            <span className="text-sm text-gray-500">Practise, Create and Share MCQs</span>
                        </div>

    ...
    return (
        <div>
            ...
            <div className="page-container flex flex-col justify-center items-center">
                ...
                <div className="telegram-link my-10 flex flex-col justify-center items-center gap-2 bg-gray-100 py-3 px-4 border-2 rounded-md mx-3">
                ...
                <div className="app-link my-10 flex flex-col justify-center items-center gap-2 bg-gray-100 py-3 px-4 border-2 rounded-md mx-3 w-[95%]">
                ...
                <div className="hide exam-div dropdown-div">
                    <button
                        id="dropßdownHoverButton"
                        data-dropdown-toggle="dropdownHover"
                        data-dropdown-trigger="hover"
                ...
                <div className="app-features flex flex-col justify-start items-start gap-2 bg-gray-100 py-3 px-4 border-2 rounded-md mx-3 my-10 w-[95%]">
                    <h1 className="text-xl font-bold text-gray-800">Features:</h1>
                    <div className="flex justify-start mcq items-center gap-2">
                        <i className="fa-regular fa-circle-check text-green-500"></i>
                        <span className="text-sm text-gray-500">Practise, Create and Share MCQs</span>

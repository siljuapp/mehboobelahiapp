...
class DrawShapeUtil extends import_editor.ShapeUtil {
  ...
  component(shape) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_editor.SVGContainer, { id: shape.id, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawShapeSvg, { shape, zoomLevel: this.editor.getZoomLevel() }) });
  }
  indicator(shape) {
  ...
  toSvg(shape, ctx) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("g", { transform: `scale(${scaleFactor})`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrawShapeSvg, { shape, zoomLevel: 1 }) });
  }
  getCanvasSvgDefs() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "path",
      {
        ...
        strokeWidth: sw,
        strokeDasharray: isDot ? "none" : (0, import_getPath.getDrawShapeStrokeDashArray)(shape, sw, zoomLevel),
        strokeDashoffset: "0"
      }
    )
  ] });
